// aqil-volunteering/backend/controllers/userDataEntryArchiveModel.js
module.exports = (sequelize, DataTypes) => {
  const UserDataEntryArchive = sequelize.define('UserDataEntryArchive', {
    ...
    tableName: 'user_data_entries_archive',
    timestamps: true,
    underscored: true
  });

  return UserDataEntryArchive;
};
